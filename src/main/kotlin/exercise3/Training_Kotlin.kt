 ...
 *
 * In Kotlin, for such cases Data classes can be used.
 * Implement current empty class as Kotlin data class and compare how much the version in Kotlin and Java differ.
 */
class Training_Kotlin